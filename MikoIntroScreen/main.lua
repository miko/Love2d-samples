...
function love.load()
  I=Intro()
  I:addText('LoveJam Test Jam entry!'):setPosition(20, 50):setColor(0, 255, 0):setFont(60):center()
  I:addText('Made with Love2d'):setPosition(400, 200):setColor(0, 0, 255):setFont(30)
